			...
			<div class="row-fluid form-wrapper">
				...
				<div class="span9 with-sidebar">
					<div class="container">
						...
						?>
						<?php echo $form->field($model, 'adminuser')->textInput(['class' => 'span9', 'disabled' => true ])->label('管理员账号'); ?>
						<?php echo $form->field($model, 'adminemail')->textInput(['class' => 'span9'])->label('管理员邮箱'); ?>
						<?php echo $form->field($model, 'adminpasswd')->passwordInput(['class' => 'span9'])->label('管理员密码'); ?>
